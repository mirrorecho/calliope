...
#         bubbles = [b for b in dir(seq_bubble) if isinstance(getattr(seq_bubble,b), self.child_types)]
#         return bubbles
...
#     child_types=(BubbleStaff, BubbleGridMatch)
#     instrument = None
...
#     """
#     child_types=(BubbleVoice) # needed? (throws exception otherwise... why?)
#     instrument=None
#     clef=None
...
#     child_types=(BubbleStaff, BubbleStaffGroup)
